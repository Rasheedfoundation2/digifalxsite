        ...
        setAdditionalInputs(
          <div className="mb-4">
            ...
            <input
              ...
              id="college"
              name="college"
              className="shadow appearance-none border rounded w-full py-2 px-3  bg-neutral-200 text-neutral-800 leading-tight focus:outline-none focus:ring-2 focus:ring-black"
        ...
        setAdditionalInputs(
          <div className="mb-4">
            ...
            <input
              ...
              id="experience"
              name="experience"
              className="shadow appearance-none border rounded w-full py-2 px-3  bg-neutral-200 text-neutral-800 text-lg leading-tight focus:outline-none focus:ring-2 focus:ring-black"
